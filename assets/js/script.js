...
const ValTotal = () => {
    ...
    const data = {
        ...
        afautonomo: parseInt((rangeInputafautonomo.value) * 5),
        ampautonomo: parseInt((rangeInputampautonomo.value) * 2),
        afteleop: parseInt((rangeInputaf.value) * 2),
        afteleopamp: parseInt((rangeInputafc.value) * 5),
        ampf: parseInt(rangeInputapf.value),
        zona,
        corrente,
